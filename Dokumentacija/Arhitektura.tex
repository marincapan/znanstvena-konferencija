		...
		\end{packed_item}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} predsjedavajuciID	& INT &   jedinstveni brojčani identifikator predsjedavajućeg konferencije (Korisnik.ID)	\\ \hline 
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}tipPolje	& VARCHAR & tip dodatnog polja obrasca  	\\ \hline 
