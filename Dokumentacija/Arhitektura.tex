		...
		\end{packed_item}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} sifSekcija	& INT & jedinstvena brojčana oznake sekcije (Sekcija.ID) u koju
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} sifKonferencija	& ID &   jedinstveni brojčani identifikator konferencije (Konferencija.ID)	\\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} predsjedavajuciID	& ID &   jedinstveni brojčani identifikator predsjedavajućeg konferencije (Korisnik.ID)	\\ \hline 
				...
				\begin{longtblr}[
					...
					\hline \multicolumn{3}{|c|}{\textbf{OdabranoPoljeObrasca}}	 \\ \hline[3pt]
					\SetCell{LightGreen}ID & INT	&  jedinstveni brojčani identifikator	\\ \hline
					\SetCell{LightBlue} sifDodatnoPoljeObrasca	& VARCHAR & jedinstveni identifikator dodatnog polja obrasca  (DodatnoPoljeObrasca.ID)	\\ \hline 
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} recenzentID	& ID & jedinstveni identifikator recenzenta (Korisnik.ID)	\\ \hline 
					\SetCell{LightBlue} sifRad	& ID &   jedinstveni identifikator rada koji se recenzira (Rad.ID)	\\ \hline 
				\end{longtblr}
				\textbf{Rad}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}poljeObrascaID& INT	&  jedinstveni brojčani identifikator polja obrasca	\\ \hline
