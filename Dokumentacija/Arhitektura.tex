...
\begin{itemize}
	...
	\end{itemize}
		...
		\section{Dijagram razreda}
			...
			Zbog lakše organizacije, razredi su logički podijeljeni po pravu pristupa metodama određenih aktora. Iz naziva i tipova atributa u razredima može se zaključiti vrsta ovisnosti među različitim razredima. \newline
			Na slici 4.5 prikazana je skica dijagrama razreda Views, koji će kasnije biti razrađen u detalj te će prikazivati stvarne, implementirane metode.
