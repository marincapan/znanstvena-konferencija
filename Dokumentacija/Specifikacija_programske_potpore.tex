	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\end{packed_item}
					...
					\end{packed_item}
						\noindent \underbar{\textbf{UC6 - Upravljanje vlastitim radovima (specijalizacije opisane u nastavku)}}
					...
					\noindent \underbar{\textbf{UC8 - Upravljanje registriranim korisnicima (sudionicima i odobrenim recenzentima) }}
					\noindent \underbar{\textbf{(specijalizacije opisane u nastavku)}}
					\newline
					...
					\noindent \underbar{\textbf{UC11 -Upravljanje predanim radovima (specijalizacije opisane u nastavku)}}
					\newline
