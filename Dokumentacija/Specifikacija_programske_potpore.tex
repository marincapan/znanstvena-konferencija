	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\end{packed_item}
					...
					\noindent \underbar{\textbf{UC6 - Prijava dodatnog rada}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik bira gumb "Moji radovi" iz glavnog izbornika
							\item Na stranici "Moji radovi" korisnik odabire opciju "Želim prijaviti još jedan rad na konferenciju"
							\item Korisnik ispunjava formu za predaju rada (ista polja kao i pri registraciji)
							\item Na stranici "Moji radovi" vidi još jedan rad na popisu te može, ako želi, odmah predati rad (UC5)
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik šalje recenziju autoru rada (onom koji je označen kao osoba za kontakt) (UC10.1)
					...
					\noindent \underbar{\textbf{UC10.1 - Poslati recenziju sudioniku}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11 - Izmjena rada po zahtjevu recenzenta}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item[4.a] Korisnik prenese datoteku, ali ne odabere opciju "Zaključi predaju"
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC12 - Pregled radova}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik, po potrebi, može izmijeniti podatke o radu (UC12.1)
					...
					\noindent \underbar{\textbf{UC12.1 - Uređivanje podataka o radu}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
						\item \textbf{Cilj:} Uređivanje podataka o predanom radu
						\item \textbf{Sudionici:} Baza podataka
						\item \textbf{Preduvjet:} Korisnik je prijavljen u sustav i odabrao je rad s popisa predanih radova
						
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik je odobrao rad s popisa predanih radova
						...
						\item[] \begin{packed_enum}
							...
							\item[3.a] Korisnik unese datoteku koja nije u .pdf formatu
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC13 - Učini radove javno dostupnima}}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item[] \begin{packed_enum}
								\item[1.] Sustav javlja korisniku da odznači radove koji već jesu javno dostupni, dok to ne učini nije mu dostupna opcija "Učini radove javno dostupnima"
							\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC14 - Slanje obavijesti sudionicima i recenzentima}}
					\begin{packed_item}
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik bira gumb "Pošalji obavijesti korisnicima" iz glavnog izbornika
					...
					\noindent \underbar{\textbf{UC15 - Definiranje upitnika za registraciju}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC16 - Upravljanje sadržajem naslovnice}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC17 - Ukloni javni pristup radova}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC21 - Zahtjev za recenziju dodatnog rada}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Odobravanje zahtjeva za recenziju dodatnog rada}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Pregled statistike prijava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Praćenje podataka vezanih uz epidemiološku situaciju s COVID-19}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik pregledava podatke u organizacijske svrhe, odlučuje hoće li se konferencija održati online (u tom slučaju potrebno je o tome obavijestiti sve sudionike i učiniti sve radove javno dostupnima(UC19.1)) ili će sudionici iz određenih država morati sudjelovati na daljinu (u tom slučaju administrator ručno treba poslati e-mail tim sudionicima i njihove radove učiniti javno dostupnima) 
					...
					\noindent \underbar{\textbf{UC19.1 - Uspostava online konferencije }}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Administrator
						\item  \textbf{Cilj:} Omogućiti da se konferencija održi online: obavijestiti sve sudionike o toj odluci i učiniti sve radove javno dostupnima
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Korisnik je prijavljen u sustav i ustanovio je da se konferencija mora održati online
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							
						
							\item Korisnik je pregledao podatke o incidenciji u državama prijavljenih sudionika i ustanovio da se konferencija treba održati online
							\item Korisnik klikne gumb "Uspostavi online konferenciju"
							\item Korisniku se prikazuje tekstualni okvir u koji treba unijeti tekst poruke koja će se poslati svim sudionicima konferencije
							\item Korisnik odabire opciju "Pošalji poruku svima i učini sve radove javno dostupnima"
							\item Korisniku se otvara prozor s porukom "Jeste li sigurni da želite održavati konferenciju online?"
							\item Korisniku odabire opciju "Da"
							\item Korisnika sustav obavještava da su radovi uspješno obavljeni i da je poruka poslana
							\item Baza podataka se ažurira
						...
						\item \textbf{Opis mogućih odstupanja:}
						\item[] \begin{packed_enum}
							\item[4.a] Korisnik  je odabrao opciju "Pošalji poruku svima i učini sve radove javno dostupnima", a nije unio tekstu poruke
							\item[] \begin{packed_enum}
								\item[1.] Sustav upozorava korisnika da pokušava poslati praznu poruku.
								
							\end{packed_enum}
							\item[6.a] Korisnik odabire opciju "Ne"
							\item[] \begin{packed_enum}
								\item[1.] Korisnika se vraća na stranicu s podatcima o epidemiološkoj situaciji.
							\end{packed_enum} 
						\end{packed_enum}
						
					\end{packed_item}
						\noindent \underbar{\textbf{UC20 - Pregled trenutno aktivnih registriranih korisnika}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Trenutno aktivni korisnici" (fiksno postavljen desno pri dnu svake stranice) te mu se prikazuje broj trenutno aktivnih korisnika i njihova imena 
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.4]{dijagrami/preglednajvaznijihfunkcionalnosti.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
						\caption{Dijagram obrasca uporabe, pregled najvažnijih funkcionalnosti}
