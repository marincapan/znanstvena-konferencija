	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item registrirati se - stvoriti novi korisnički račun za koji su mu potrebni osobni podaci - ime i prezime, naziv matične ustanove (kao i ulica i kućni broj, grad i država institucije), e-mail adresa te ovisno o odabiru uloge autore rada (sudionici) te e-mail adresu autora koji je osoba za kontakt
				...
				\begin{packed_enum}
					...
					\item raditi sve što može i recenzent
				...
				\begin{packed_enum}
					...
					\item pratiti stanje COVID-19 pandemije putem javno dostupnih podataka radi razine incidencije indeksa u pojedinim državama
					\item objaviti radove online u slučaju pogoršanja epidemiološke situacije
					\item stvoriti i mijenjati obrasce prijave za sudionike
					\item vidjeti broj i imena aktivno registriranih korisnika
					\item pregledavati statistiku prijave po državama, sekcijama, radovima
					\item raditi sve što može i recenzent
