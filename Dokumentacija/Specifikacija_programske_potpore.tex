	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik koji se registrirao kao sudionik konferencije prima obavijest (putem e-maila) o uspješnoj registraciji (koju je potrebno potvrditi "klikom" na dobiveni link - UC2.1) u kojoj se nalazi lozinka za prijavu, a recenzent tu obavijest prima po odobrenju predsjedavajućeg
					...
					\noindent \underbar{\textbf{UC2.1 - Potvrda registracije putem e-maila}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik klikom na link "Potvrdi e-mail" potvrđuje da je ispravna e-mail adresa
				...
				\end{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Slanje obavijesti odabranim sudionicima}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Predsjedavajući konferencije
						...
						\end{packed_enum}
					\end{packed_item}
					\noindent \underbar{\textbf{UC21 - Slanje podsjetnika na rok za predaju radova}}
