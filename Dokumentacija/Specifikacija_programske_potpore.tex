	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik koji se registrirao kao sudionik konferencije prima obavijest (putem e-maila) o uspješnoj registraciji (koju je potrebno potvrditi "klikom" na dobiveni link) u kojoj se nalazi lozinka i korisničko ime (jedinstveni identifikator ID\_xxxx, pri čemu je xxxx redni broj prijave s kojom se prijavljuje u sustav), a recenzent tu obavijest prima po odobrenju predsjedavajućeg
						\end{packed_enum}
						...
						\item[] \begin{packed_item}
							...
							\item[2.a]  Odabir već zauzetog e-maila, unos jednog ili više korisničkih podataka u nedozvoljenom formatu
							\item[] \begin{packed_enum}
				...
				\end{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item[] \begin{packed_enum}
								\item[1.] Sustav javlja korisniku kako promjene nisu spremljene prije izlaska iz prozora
							\end{packed_enum}
							\item[4.b] Korisnik je učitao datoteku koja nije u .pdf obliku
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC30 - Pregled statistike prijava}}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC31 - Praćenje podataka vezanih uz epidemiološku situaciju s COVID-19}}
					\begin{packed_item}
					...
					\end{packed_item}
						\noindent \underbar{\textbf{UC32 - Pregled trenutno aktivnih registriranih korisnika}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Trenutno aktivni korisnici" pri dnu stranice te mu se prikazuje broj trenutno aktivnih korisnika i njihova imena 
