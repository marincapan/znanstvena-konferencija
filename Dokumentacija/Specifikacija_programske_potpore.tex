	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[2.a]  Odabir već zauzetog e-maila, unos jednog ili više korisničkih podataka u nedozvoljenom formatu, postoji već rad s tim naslovom
							\item[] \begin{packed_enum}
				...
				\end{packed_item}
					...
					\noindent \underbar{\textbf{UC24 - Odobravanje zahtjeva za predaju dodatnog rada}}
					\begin{packed_item}
