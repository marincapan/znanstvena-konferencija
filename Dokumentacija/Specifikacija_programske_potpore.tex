\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik na naslovnici ili u glavnom izborniku bira opciju "Prijava", nakon čega se učitava stranica za prijavu
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Korisniku je učitana stranica za prijavu, odabire gumb "Zaboravljena lozinka"
				...
				\end{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik klikom na gumb "Osobni podaci" otvara stranicu svog profila
					...
					\begin{packed_item}
						...
						\item  \textbf{Preduvjet:} 
							\item[] \begin{packed_item}
								\item Korisnik je prijavljen u sustav, prvi rad još nije predan (.pdf nije učitan i pohranjen)
								\item Prošao je datum početka predaje radova, ali nije još prošao rok za predaju radova
							\end{packed_item}
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik klikne na gumb "Moji radovi" iz glavnog izbornika
							\item Aplikacija prikazuje popis predanih radova povučen iz baze podataka
							\item Korisnik u odjeljku "Predaja dodatnog rada" ispunjava obrazac za predaju dodatnog rada
					...
					\noindent \underbar{\textbf{UC9 - Pregled svih recenzenata}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administrator" iz izbornika, te pod odjeljkom \textit{Općenito} odabire opciju "Pregled korisnika i radova"
							\item Nakon što mu se učita stranica odabire "Popis recenzenata (odobrenih i neodobrenih)" te mu se učita stranica s popisom svih recenzenata
							\item Korisnik odabire recenzenta s popisa
							\item Korisniku se prikazuju podaci koje je recenzent unio pri registraciji, administrator ima mogućnost mijenjanja podataka o odabranom recenzentu (UC10.1)
							\item Predsjedavajući konferencije može ili odobriti(UC9.1) ili odbiti registraciju recenzenta (UC9.2) ukoliko taj recenzent još nije potvrđen
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administrator" iz izbornika, te pod odjeljkom \textit{Općenito} odabire opciju "Pregled korisnika i radova"
							\item Nakon što mu se učita stranica odabire "Popis registriranih sudionika" te mu se učita stranica s popisom svih sudionika
							...
							\item Administrator po potrebi može urediti podatke sudionika (UC10.1)
					...
					\noindent \underbar{\textbf{UC10.1 - Uređivanje podataka o korisniku}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik je odabrao željenog korisnika s popisa te ga sustav odvede na stranicu s podacima o odabranom korisniku koje tada može mijenjati
							\item Korisnik mijenja željene podatke
							\item Korisnik bira opciju "Ažuriraj podatke"
							\item Baza podataka se ažurira
						\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC11 - Dodavanje novog administratora}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik u administracijskom sučelju (pod odjeljkom \textit{Upravljanje administratorima}) bira opciju "Dodaj novog administratora"
							\item Korisnik unosi osobne podatke (ime, prezime, adresa e-pošte, korisničko ime) administratora kojeg želi dodati

							\item Korisnik odabire opciju "Dodaj administratora"
					...
					\noindent \underbar{\textbf{UC12 - Recenziranje rada}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik bira gumb "Moje recenzije" iz glavnog izbornika te mu se učitava stranica sa radovima dostupnima za recenziju (iz sekcije koju je odabrao pri registraciji)
							...
							\item Ažurira se baza podataka te se recenzija šalje autoru rada putem e-pošte (onom koji je označen kao osoba za kontakt) (UC12.1)
					...
					\noindent \underbar{\textbf{UC12.1 - Poslati recenziju sudioniku}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Recenzent
					...
					\noindent \underbar{\textbf{UC13 - Pregled vlastitih recenzija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC14 - Pregled radova}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administrator" iz izbornika (ili "Predsjedavajući" ukoliko je predsjedavajući prijavljen), te pod odjeljkom \textit{Općenito} odabire opciju "Pregled korisnika i radova" (Predsjedavajućem se ti popisi odmah prikazuju u njegovom upravljačkom sučelju)
							\item Nakon što mu se učita stranica odabire "Pregled radova" te mu se učita stranica s popisom svih radova
							\item Korisnik (ukoliko želi) unosi ograničenja u filtar te mu se sukladno prikazuje popis radova koji odgovaraju rezultatima filtra
							\item Korisnik odabire rad s popisa
							\item Korisnik, ukoliko to želi, preuzima rad lokalno na računalo klikom na gumb "Preuzmi rad"
							\item Korisniku se prikazuju podatci o odabranom radu, administator (ukoliko želi) mijenja podatke o radu (UC19)
					...
					\noindent \underbar{\textbf{UC15 - Preuzimanje svih predanih radova}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, predsjedavajući konferencije
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administrator" iz izbornika, te pod odjeljkom \textit{Općenito} odabire opciju "Pregled korisnika i radova"
							\item Nakon što mu se učita stranica odabire "Predani radovi" te mu se učita stranica s popisom svih predanih radova
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Korisnik je prijavljen u sustav, postoje predani radovi i oni trenutačno nisu javni
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Korisnik odabire gumb "Administrator" iz izbornika, te pod odjeljkom \textit{Općenito} odabire opciju "Učini radove javno dostupnima"
					...
					\noindent \underbar{\textbf{UC17 - Ukloni javni pristup svim radovima}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administrator" iz izbornika, te pod odjeljkom \textit{Općenito} odabire opciju "Ukloni javni pristup radovima"
					...
					\noindent \underbar{\textbf{UC18 - Pregled javno dostupnih radova}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisnik odabire gumb "Javno dostupni radovi" iz izbornika (ili s naslovnice) te mu se učitava stranica s popisom svih radova
					...
					\noindent \underbar{\textbf{UC19 - Uređivanje podataka o radu}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administrator" iz izbornika, te pod odjeljkom \textit{Općenito} odabire opciju "Pregled korisnika i radova"
							\item Nakon što mu se učita stranica odabire "Pregled radova" te mu se učita stranica s popisom svih predanih radova
					...
					\noindent \underbar{\textbf{UC20 - Slanje obavijesti odabranim korisnicima}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Predsjedavajući konferencije, administrator
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik bira gumb "Administrator" iz glavnog izbornika
							\item Korisnik bira gumb "Pošalji obavijest putem e-pošte" pod odjeljkom \textit{Općenito}
							\item Korisniku se pojavljuje polja za unos naziva i teksta obavijesti te popis korisnika, koje zatim po želji odabire i/ili filtrira (po sekciji ili po državi), a može i kliknuti gumb "Odaberi sve"
							\item Nakon što je odabran minimalno jedan korisnik, dostupna je opcija "Pošalji obavijest"
					...
					\noindent \underbar{\textbf{UC21 - Definiranje upitnika za registraciju}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik u zaglavlju bira gumb "Administrator" iz glavnog izbornika te bira odjeljak \textit{Upravljanje obrascem za registraciju}
					...
					\noindent \underbar{\textbf{UC22 - Upravljanje sadržajem naslovnice}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik bira gumb "Administracijsko sučelje" te pod odjeljkom \textit{Uređivanje naslovne stranice} unosi naziv članka i tekst istoga
							\item Kada je gotov korisnik bira opciju "Dodaj članak"
						\end{packed_enum}
					
						\item \textbf{Opis mogućih odstupanja:}
						\item[] \begin{packed_enum}

							\item[3.a] Korisnik unese promjene, ali ne odabere opciju "Dodaj članak"
							\item[] \begin{packed_enum}
								\item[1.] Sustav javlja korisniku kako promjene nisu spremljene prije izlaska iz prozora
							\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC23 - Pregled statistike prijava}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Administracijsko sučelje" iz glavnog izbornika te pod odjeljkom \textit{Općenito} bira opciju "Pogledaj statistiku prijava"
							\item Korisniku se učitava stranica s informacijama o prijavljenim sudionicima, recenzentima i radovima

						\end{packed_enum}
			
					\end{packed_item}
				
					\noindent \underbar{\textbf{UC24 - Praćenje podataka vezanih uz epidemiološku situaciju s COVID-19}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator odabire gumb "Administrator" iz izbornika(dok predsjedavajući konferencije odabire gumb "Predsjedavajući"), zatim pod odjeljkom \textit{Općenito} bira opciju "COVID-19 statistika" koji ga vodi na stranicu s informacijama o situaciji s koronavirusom u državama iz koje su sudionici prijavili radove (
					...
					\noindent \underbar{\textbf{UC25 - Pregled trenutno aktivnih registriranih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC26 - Odjava iz sustava}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik bira opciju "Odjava" iz izbornika u zaglavlju
					...
					\noindent \underbar{\textbf{UC27 - Upravljanje informacijama o konferenciji}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik bira opciju "Administracijsko sučelje" iz glavnog izbornika
							\item Pod odjeljkom \textit{Podaci o konferenciji} korisnik mijenja željene informacije
							\item Korisnik bira opciju "Ažuriraj podatke"
							\item Ažurira se baza podataka te su ažurirane informacije vidljive na stranici "O konferenciji"
						\end{packed_enum}
					
						\item \textbf{Opis mogućih odstupanja:}
						\item[] \begin{packed_enum}

							\item[5.a] Korisnik unese promjene, ali ne odabere opciju "Ažuriraj podatke"
							\item[] \begin{packed_enum}
								\item[1.] Sustav javlja korisniku kako promjene nisu spremljene prije izlaska iz prozora
							\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC28 - Uređivanje podataka o predsjedavajućem konferencije}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item[] \begin{packed_enum}
							\item Korisnik bira opciju "Administracijsko sučelje" iz glavnog izbornika
							\item Pod odjeljkom \textit{Upravljanje podacima o predsjedavajućem konferencija} korisnik mijenja željene informacije
				...
				\noindent \underbar{\textbf{UC29 - Potvrda registracije putem e-pošte}}
				\begin{packed_item}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\textbf{Obrazac uporabe UC12 - Recenziranje rada}\\
				...
				\begin{figure}[H]
					...
					\centering
					\caption{Sekvencijski dijagram za UC12 - Recenziranje rada}
				...
				\textbf{Obrazac uporabe UC20 - Slanje obavijesti određenim korisnicima}\\
				
				\indent Predsjedavajući konferencije (i administrator) ima mogućnost, ukoliko se ukaže potreba, poslati obavijest sudionicima i recenzentima (o bilokakvoj promjeni vezanoj za konferenciju i sl.). Isto čini tako da pristupi stranici "Upravljačko sučelje" (kod admina - "Administracijsko sučelje") te odabere opciju na vrhu stranice "Pošalji obavijest putem e-pošte" pri čemu se otvara stranicas okvirom za unos teksta te prozor za odabir korisnika kojima korisnik želi poslati obavijest (te stoji opcija "Odaberi sve" ukoliko želi svima poslati obavijest). Korisnik unosi tekst obavijesti, a kad je siguran da želi poslati obavijest bira opciju "Pošalji". Iz baze podataka dohvaćaju se adrese e-pošte odabranih sudionika i recenzenata te se putem Web-aplikacije šalje e-poštu na sve adrese povučene iz baze podataka. Korisnik prima obavijest o uspješnom slanju obavijesti.
				\eject

				\begin{figure}[H]
					\includegraphics[scale=0.45]{dijagrami/UC21-SlanjeMaila.png} 
					\centering
					\caption{Sekvencijski dijagram za UC20 - Slanje obavijesti određenim korisnicima}
				...
				\textbf{Obrazac uporabe UC27 - Upravljanje informacijama o konferenciji}\\

				
				\indent Administrator je dužan ažurirati informacije o konferenciji, što čini putem stranice "Administracijsko sučelje". Tamo može, između ostaloga, prvi puta odabrati predsjedavajućeg konferencije (UC28 - također uključen u ovaj dijagram), a kasnije može i mijenjati podatke o njemu (promijeniti osobne podatke, unijeti novu adresu e-pošte i sl.). Ukoliko administrator promijeni adresu e-pošte predsjedavajućeg, na novu adresu dolazi poruka s lozinkom za prijavu u sustav. Nadalje, na navedenoj stranici može odabrati odsječak po svojoj želji, izmijeniti podatke te na kraju odabrati "Ažuriraj podatke". Pri tome se baza podataka ažurira, kao i stranica koju sudionici i recenzenti vide. Pod "mijenjanjem podataka" podrazumijeva se promjena rokova za registraciju/predaju radova, kao i opis i naziv konferencije.
				...
				\begin{figure}[H]
					...
					\centering
					\caption{Sekvencijski dijagram za UC27 - Upravljanje informacijama o konferenciji (uz UC28)}
