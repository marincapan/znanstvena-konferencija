	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\end{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik ima mogućnost promjene podataka o radu(UC6.2)
							\item Korisnik ima mogućnost izmjene rada ukoliko je to zahtjevao recenzent(UC6.3)
							
						\end{packed_enum}
						
					\end{packed_item}
						\noindent \underbar{\textbf{UC6.1 - Predaja dodatnog rada}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item Korisniku je otvorena stranica "Moji radovi"
						...
						\item[] \begin{packed_item}
							...
							\item[4.a]  Korisnik prenese datoteku, ali ne odabere opciju "Predaj rad"
							\item[] \begin{packed_enum}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC6.2 - Promjena podataka o vlastitom radu}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisniku su prikazani podatci o radu odabranom s popisa vlastitih radova
						...
						\item[] \begin{packed_item}
							...
							\item[3.a]  Korisnik izvrši promjenu podataka, ali ne odabere opciju "Spremi promjene"
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC6.3 - Izmjena rada po zahtjevu recenzenta}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item[3.a] Korisnik prenese datoteku, ali ne odabere opciju "Zaključi predaju"
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC11 - Pregled radova}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Predsjedavajući konferencije ima mogućnost preuzimanja svih radova na lokalno računalo (UC11.1)
							\item Administrator ima mogućnost ukloniti javni pristup radovima ako je prethodno omogućen (UC11.2)
							...
							\item Korisnik, ukoliko on to želi, može preuzeti rad na vlastito računalo (UC11.4)
					...
					\noindent \underbar{\textbf{UC11.1 - Preuzimanje svih predanih radova}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Predsjedavajući konferencije
						...
						\end{packed_enum}
					\end{packed_item}
					\noindent \underbar{\textbf{UC11.2 - Ukloni javni pristup svim radovima}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik ima otvorenu stranicu stranica s popisom svih radova
					...
					\noindent \underbar{\textbf{UC11.3 - Uređivanje podataka o radu}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisniku su prikazana stranica s podatcima o odabranom radu s popisa predanih radova
					...
					\noindent \underbar{\textbf{UC11.4 - Preuzimanje rada}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
						\item \textbf{Cilj:} Preuzimanje svih predanih radova
						\item \textbf{Sudionici:} Baza podataka
						\item \textbf{Preduvjet:} Korisnik je prijavljen u sustav i odabrao je rad koji želi preuzeti
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[scale=0.35]{dijagrami/pregledvaznijihfunkcionalnosti.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
