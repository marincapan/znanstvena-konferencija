	...
	\section{Funkcionalni zahtjevi}
       ...
       stito računalo (UC11.4)\item Korisnik odabire opciju "Predani radovi" 
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\end{figure}
					\begin{figure}[H]
						\includegraphics[scale=0.35]{dijagrami/funkcionalnosti-sudionici-recenzenti.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
						\caption{Dijagram obrasca uporabe, funkcionalnosti sudionika i recenzenata}
						\label{fig:dijagramobrascauporabe2}
					\end{figure}
						\begin{figure}[H]
						\includegraphics[height=15cm,keepaspectratio]{dijagrami/funkcionalnosti-administrator-predsjedavajucikonferencije.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
						\centering
