			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: } Neprijavljeni korisnik, registrirani korisnik, admininistrator, predsjedavajući konferencije
				...
				\end{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[3.b]  Korisnik prenese datoteku, ali ne odabere opciju "Predaj"
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisniku se ponovno učitava stranica "Moji radovi" na kojoj je sada vidljiv novi rad (koji je moguće mijenjati do roka za izmjenu)
						...
						\item[] \begin{packed_item}
							...
							\item[3.b]  Korisnik prenese datoteku, ali ne odabere opciju "Predaj rad"
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC25 - Recenzija dodatnog rada nakon inicijalnog}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: } Recenzent
						\item  \textbf{Cilj:} Recenzirati još jedan rad osim prethodno ocijenjenih
						\item  \textbf{Sudionici:} Baza podataka
						...
						\item[] \begin{packed_enum}
							...
							\item Korisniku se prikazuje prozor s pitanjem "Molimo potvrdite da želite recenzirati dodatan rad klikom na gumb "Ok"." s opcijama "Ok" i "Odustani"
							\item Korisnik bira opciju "Ok"
							\item Korisniku se ponovno učitava stranica "Moji radovi" na kojoj se pojavljuje još jedan, nasumično izabran rad za recenziju (iz sekcije koju je naveo pri prijavi)
						...
						\item[] \begin{packed_enum}
							...
							\item[] \begin{packed_enum}
								\item[1.] Uklanja se prozor i korisnik se vraća na stranicu "Moji radovi"
							\end{packed_enum}
						\end{packed_enum}
					\end{packed_item}

					\noindent \underbar{\textbf{UC26 - Pregled statistike prijava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC27 - Praćenje podataka vezanih uz epidemiološku situaciju s COVID-19}}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC28 - Pregled trenutno aktivnih registriranih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC29 - Odjava iz sustava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC30 - Upravljanje informacijama o konferenciji}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik, ukoliko to želi, postavlja predsjedavajućeg konferencije (UC30.1)
					...
					\noindent \underbar{\textbf{UC30.1 - Odabir predsjedavajućeg konferencije}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
