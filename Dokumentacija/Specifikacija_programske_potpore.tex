			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item \textbf{Glavni sudionik: } Neregistrirani korisnik, registrirani korisnik, admininistrator, predsjedavajući konferencije
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[2.a]  Neispravvan e-mail ili lozinka
							\item[] \begin{packed_enum}
				...
				\end{packed_item}
					...
					\end{packed_item}
						\noindent \underbar{\textbf{UC6.1 - Pregled vlastitih radova}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik može, ako želi, predati još koji rad (UC6.1)
       u(UC6.2)
       to zahtjevao recenzent(UC6.3)
					
						\end{packed_enum}                
						
					\end{packed_item}
						\noindent \underbar{\textbf{UC6.2 - Predaja dodatnog rada}}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC6.3 - Promjena podataka o vlastitom radu}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Registrirani korisnik
						Korisnik ima otvorenu stranicu s podatcima o svom radu
      						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Korisnik je prijavljen u sustav
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik klikne na gumb "Moji radovi" iz glavnog izbornika
							\item Aplikacija prikazuje popis predanih radova povučen iz baze podataka
							\item Korisnik odabire rad s popisa te mu se otvara stranica s podatcima o radu
							\item Korisnik odabere opciju "Promijeni podatke"
							\item Korisnik radi željene izmjene
							\item Korisnik odabire opciju "Spremi promjene"
							\item Baza podataka se ažurira
						...
						\item[] \begin{packed_item}
							...
							\item[5.a]  Korisnik izvrši promjenu podataka, ali uneseni podaci nisu u ispravnom formatu
							\item[] \begin{packed_enum}
							...
							\item[6.a]  Korisnik izvrši promjenu podataka, ali ne odabere opciju "Spremi promjene"
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC6.4 - Izmjena rada po zahtjevu recenzenta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - Pregled recenzenata koji čekaju na odobrenje}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7.1 - Odobravanje registracije recenzenta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7.2 - Odbijanje registracije recenzenta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8.1 - Pregled registriranih sudionika}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik po potrebi može urediti podatke sudionika (UC8.1.1)
					...
					\noindent \underbar{\textbf{UC8.1.1 - Uređivanje podataka o sudioniku}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
					...
					\noindent \underbar{\textbf{UC8.2 - Pregled odobrenih recenzenata}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik po potrebi može promijeniti podatke recenzenta (UC8.2.1)
					...
					\noindent \underbar{\textbf{UC8.2.1 - Uređivanje podataka o recenzentu}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
					...
					\noindent \underbar{\textbf{UC9 - Dodavanje novog administratora}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC10 - Recenziranje rada}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik bira opciju "Recenziraj ovaj rad" te se time pojavljuje prozor s pitanjem "Jeste li sigurni da želite recenzirati ovaj rad?" s opcijama "Da" ili "Ne"
							...
							\item Recenzentu se recenzija dodaje na popis recenzija te ju može pregledati u izborniku "Moje recenzije" (UC10.2)
					...
					\noindent \underbar{\textbf{UC10.1 - Slanje recenzije sudioniku}}
					\begin{packed_item}
					...
					\end{packed_item}
					\noindent \underbar{\textbf{UC10.2 - Pregled vlastitih recenzija}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11.1 - Pregled radova}}
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Baza podataka
						\
                                                                                                p       isomsvih radov                                             textbf{Preduvjet:} Korisnik je prijavljen u sustav
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
							\item Korisnik odabire gumb "Korisnici i radovi" iz izbornika te mu se učitava stranica s opcijama
							\item Korisnik, po potrebi, može izmijeniti podatke o radu (UC11.3)
       stito računalo (UC11.4)\item Korisnik odabire opciju "Predani radovi" 
					...
					\noindent \underbar{\textbf{UC11.2 - Preuzimanje svih predanih radova}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Predsjedavajući konferencije
						...
						\end{packed_enum}
					\end{packed_item}
					\noindent \underbar{\textbf{UC11.3 - Ukloni javni pristup svim radovima}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC11.4 - Uređivanje podataka o radu}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
						...
						\item[] \begin{packed_enum}
							...
							\item[6.a] Korisnik unese datoteku koja nije u .pdf formatu
							\item[] \begin{packed_enum}
							...
							\end{packed_enum}
							\item[7.a] Korisnik unese promjene, ali ne odabere opciju "Spremi promjene"
							\item[] \begin{packed_enum}
								\item[1.] Sustav javlja korisniku kako promjene nisu spremljene prije izlaska iz prozora
							\end{packed_enum}               
						\end{packed_enum}
					...
					\noindent \underbar{\textbf{UC11.5 - Preuzimanje rada}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator, Predsjedavajući konferencije
						\item \textbf{Cilj:} Preuzimanje rada
						\item \textbf{Sudionici:} Baza podataka
						\item \textbf{Preduvjet:} Korisnik je prijavljen u sustav 
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire gumb "Korisnici i radovi" iz izbornika te mu se učitava stranica s opcijama
							\item Korisnik odabire opciju "Predani radovi" 
							\item Korisniku je prikazan popis svih predanih radova
							\item Korisnik odabire rad koji želi preuzeti
							\item Korisniku je prikazana stranica s podatcima o radu odabranom s popisa predanih radova
							\item Korisnik bira opciju "Preuzmi rad" te preuzima sve radove na lokalno računalo
					...
					\noindent \underbar{\textbf{UC12 - Slanje obavijesti sudionicima i recenzentima}}
					\begin{packed_item}
						...
						\item \textbf{Opis osnovnog tijeka:} 
						\item[] \begin{packed_enum}
							\item Korisnik bira gumb "Pošalji obavijest sudionicima" iz glavnog izbornika
						...
						\item[] \begin{packed_enum}
							...
							\end{packed_enum}
							\item[5.b] Korisnik ne odabere ni jednog primatelja obavijesti, a odabere opciju "Pošalji".
							\item[] \begin{packed_enum}
								\item[1.] Sustav javlja korisniku kako mora odabrati barem jednog primatelja.
							\end{packed_enum}
							\item[5.c] Korisnik ne upiše ništa u polje za unos teksta, a odabere opciju "Pošalji".
							\item[] \begin{packed_enum}
					...
					\noindent \underbar{\textbf{UC13 - Definiranje upitnika za registraciju}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC14 - Upravljanje sadržajem naslovnice}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC15 - Pregled statistike prijava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC16 - Praćenje podataka vezanih uz epidemiološku situaciju s COVID-19}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Po potrebi administrator može učiniti sve radove javno dostupnima (UC16.1)
					...
					\noindent \underbar{\textbf{UC16.1 - Učini radove javno dostupnima}}
					...
					\noindent \underbar{\textbf{UC17 - Pregled trenutno aktivnih registriranih korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Odjava iz sustava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Upravljanje informacijama o konferenciji}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
					...
					\noindent \underbar{\textbf{UC19.1 - Odabir predsjedavajućeg konferencije}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik:} Administrator
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\end{figure}
						\begin{figure}[H]
						\includegraphics[height=15cm,keepaspectratio]{dijagrami/funkcionalnosti-administrator-predsjedavajucikonferencije.png} 
						\centering
			...
			\subsection{Sekvencijski dijagrami}
				...
				\textbf{Obrazac uporabe UC10 - Recenziranje rada}\\
				Recenzent na stranici radova može koliko želi odabirati radove, čitati ih i pregledavati. Kada odabere i pročita rad koji namjerava recenzirati, a rad prethodno nije recenziran, kreće se prema dnu stranice gdje se nalazi odabir ocjene te mora odabrati jednu od četiri ocjene koje su definirane u opisu zadatka te je svakoj dodijeljen simboličan broj (u bazi podataka i u dokumentaciji). Bira jednu od 4 ocjene, te ovisno o tome koju ocjenu je odabrao (ukoliko su to ocjene 2., 3. ili 4.) pojavljuje se polje za upis obrazloženja ocjene. Korisnik može mijenjati ocjenu klikom sve dok se ne odluči za svoju konačnu ocjenu (i po potrebi unese obrazloženje ocjene), nakon čega korisnik bira opciju "Recenziraj ovaj rad". Klikom na navedenu opciju, otvara se prozor s pitanjem "Jeste li sigurni da želite recenzirati ovaj rad?". Ukoliko korisnik odabere opciju "Da", recenzija se pohranjuje u bazi podataka (te je sukladno dostupna na stranici "Moje recenzije"), a ako korisnik odabere opciju "Ne" ponovno se učitava stranica radova te korisnik opet ima mogućnost pregledavati radove s ciljem recenziranja.
				\eject

				\begin{figure}[H]
					\includegraphics[scale=0.58]{dijagrami/UC10-RecenziranjeRada.png} 
					\centering
					\caption{Sekvencijski dijagram za UC10 - Recenziranje rada}
